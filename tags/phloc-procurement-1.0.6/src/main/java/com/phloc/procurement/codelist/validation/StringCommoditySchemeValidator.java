...
public final class StringCommoditySchemeValidator extends AbstractStringValidator
{
  @Nonnull
  public IValidationResult validate (@Nullable final String sValue)
  {
    if (ECommodityScheme.getFromIDOrNull (sValue) != null)
      return ValidationResultSuccess.getInstance ();
    return new ValidationResultError (ECommoditySchemeErrorTexts.INVALID_COMMODITY_SCHEME);
  }
}
