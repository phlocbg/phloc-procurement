 ...
 */
package com.phloc.procurement.idscheme.validation;
...
public final class StringEntityIDSchemeValidator extends AbstractStringValidator
{
  @Nonnull
  public IValidationResult validate (@Nullable final String sValue)
  {
    if (EntityIDSchemeManager.getInstance ().getIDSchemeFromID (sValue) != null)
      return ValidationResultSuccess.getInstance ();
    return new ValidationResultError (EEntitySchemeErrorTexts.INVALID_ENTITYID_SCHEME);
  }
}
