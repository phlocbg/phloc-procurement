...
public enum EUBLOrderCustomization implements IUBLCACCustomization
{
  STANDARD,
  PEPPOL
  {
    ...
    {
      return "urn:www.cenbii.eu:transaction:biicoretrdm001:ver1.0:#urn:www.peppol.eu:bis:peppol1a:ver1.0";
    }

    @Override
    public String getProfileID ()
    {
      return "urn:www.cenbii.eu:profile:bii01:ver1.0";
    }
    ...
    @Override
    public boolean isOrderLineCommodityClassificationAllowed ()
    {
      return false;
    }
