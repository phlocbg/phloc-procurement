...
@Immutable
public final class JPAEntityIDSchemeConverter implements Converter
{
  public String convertObjectValueToDataValue (final Object aObjectValue, final Session aSession)
  {
    return aObjectValue == null ? null : ((IEntityIDScheme) aObjectValue).getID ();
  }

  public EntityIDScheme convertDataValueToObjectValue (final Object aDataValue, final Session aSession)
  {
    return aDataValue == null ? null : EntityIDSchemeManager.getInstance ().getIDSchemeFromID ((String) aDataValue);
  }
