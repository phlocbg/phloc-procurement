...
{
  /**
   * @return The date when the invoice was issued.
   */
  @Nullable
  ...
  /**
   * @return A free text with a note.
   */
  @Nullable
  String getInvoiceNote ();

  /**
   * @return The invoice lines. May be <code>null</code>.
   */
  @Nullable
  List <? extends IProcInvoiceLine> getInvoiceLines ();

  /**
   * @return The attachments of this object. May be <code>null</code>.
   */
  @Nullable
  List <? extends IProcInvoiceAttachment> getAttachments ();
